...
namespace Light_And_Shadow
{
    public class GameObject
    {
        ...
        public void Draw(Matrix4 viewProjection, Vector3 cameraPosition, World currentWorld, int debugMode = 0)
        {
            if (Renderer != null)
            {
                ...
                // Draw the object.
                Renderer.Draw(mvp, model, cameraPosition, debugMode, currentWorld);
            }
        }
    }
}
